...
abstract class $UserDTOCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String authenticationId, String name});
}
...
class _$_UserDTO implements _UserDTO {
  const _$_UserDTO(
      {required this.id, required this.authenticationId, required this.name});
  ...
  @override
  String toString() {
    return 'UserDTO(id: $id, authenticationId: $authenticationId, name: $name)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, authenticationId, name);
...
abstract class _UserDTO implements UserDTO {
  const factory _UserDTO(
      ...
      required final String name}) = _$_UserDTO;
